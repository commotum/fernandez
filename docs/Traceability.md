...
|---|---|---|---|---|
| `FER03-FND-COMPLEX-STATE-RAY` | L38, L73–90 | Normalized complex vectors modulo unit right/commutative phase. | P2 / `State/ComplexPhase.lean`, `Semantics/StatePhase.lean` | **partially formalized**: `ComplexStatePhaseEq` supplies representative-level equivalence, exact-to-phase, basis-distribution, raw matrix/circuit, and normalized unitary-evolution laws. Normalized columns remain concrete representatives until Stage 4 constructs quotient equality and descended operations |
