...
The frozen table remains the immutable seed; the proof-bearing sections below
record later checked refinements without rewriting that inventory boundary.
